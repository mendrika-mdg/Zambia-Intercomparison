...
class ShardDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        lag_col = 9  # index of lag feature
        x[..., lag_col] = 2 * (x[..., lag_col] / 120.0) - 1.0  # rescale 0–120 → −1…1
        return x, g, y
...
def main():
    ...
    BATCH_SIZE = 32
    CHECKPOINT_DIR = f"/gws/nopw/j04/wiser_ewsa/mrakotomanga/Intercomparison/checkpoints/t{LEAD_TIME}"
    ...
    logger = WandbLogger(project="zambia-cast", name=f"t{LEAD_TIME}-fss-lag-scaled")
